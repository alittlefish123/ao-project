...
public class DonateController {
    ...
    @PostMapping("/money")
    public Result money(@RequestBody  Donate donate){
    ...
    public Result findPage(@RequestParam(defaultValue = "") String name,
        ...
        Page<Donate> page = donateService.page(new Page<>(pageNum, pageSize), queryWrapper);
        page.getRecords().stream().forEach(i->{
            i.setName(userMapper.selectById(i.getUserId()).getUsername());
        });
